          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarResponsive">
              <ul className="navbar-nav">
                ...
                <li className="nav-item px-3">
                  <NavLink to="/erreur" className="nav-link">Services</NavLink>
                </li>
                <li className="nav-item px-3">
                  <NavLink to="/erreur" className="nav-link">Fabrication</NavLink>
                </li>
                <li className="nav-item px-3">
                  <NavLink to="/erreur" className="nav-link">Alimentation</NavLink>
                </li>
              </ul>
